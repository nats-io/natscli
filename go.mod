...
require (
	...
	github.com/nats-io/nats-server/v2 v2.11.0-dev.0.20240312182202-9fa359acea5b
	...
	github.com/synadia-io/jwt-auth-builder.go v0.0.0-20240308170711-55de0be37abc
