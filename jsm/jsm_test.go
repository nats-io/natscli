...
func TestCLIStreamCreate(t *testing.T) {
	...
	runJsmCli(t, fmt.Sprintf("--server='%s' str create mem1 --subjects 'js.mem.>,js.other' --storage m  --max-msgs=-1 --max-age=-1 --max-bytes=-1 --ack --retention limits --max-msg-size=1024", srv.ClientURL()))
	streamShouldExist(t, "mem1")
...
func TestCLIStreamInfo(t *testing.T) {
	...
	out := runJsmCli(t, fmt.Sprintf("--server='%s' str info mem1 -j", srv.ClientURL()))
...
func TestCLIStreamDelete(t *testing.T) {
	...
	runJsmCli(t, fmt.Sprintf("--server='%s' str rm mem1 -f", srv.ClientURL()))
...
func TestCLIStreamLs(t *testing.T) {
	...
	out := runJsmCli(t, fmt.Sprintf("--server='%s' str ls -j", srv.ClientURL()))
...
func TestCLIStreamPurge(t *testing.T) {
	...
	runJsmCli(t, fmt.Sprintf("--server='%s' str purge mem1 -f", srv.ClientURL()))
	i, err = stream.Information()
	checkErr(t, err, "could not get message stream info: %v", err)
	if i.State.Msgs != 0 {
...
func TestCLIStreamGet(t *testing.T) {
	...
	out := runJsmCli(t, fmt.Sprintf("--server='%s' str get mem1 1 -j", srv.ClientURL()))
...
func TestCLIConsumerInfo(t *testing.T) {
	...
	out := runJsmCli(t, fmt.Sprintf("--server='%s' con info mem1 push1 -j", srv.ClientURL()))
...
func TestCLIConsumerLs(t *testing.T) {
	...
	out := runJsmCli(t, fmt.Sprintf("--server='%s' con ls mem1 -j", srv.ClientURL()))
	var info []string
	err = json.Unmarshal(out, &info)
	checkErr(t, err, "could not parse output: %v", err)
...
func TestCLIConsumerDelete(t *testing.T) {
	...
	runJsmCli(t, fmt.Sprintf("--server='%s' con rm mem1 push1 -f", srv.ClientURL()))
...
func TestCLIConsumerAdd(t *testing.T) {
	...
	runJsmCli(t, fmt.Sprintf("--server='%s' con add mem1 push1 --replay instant --deliver all --pull --filter '' --max-deliver 20", srv.ClientURL()))
	consumerShouldExist(t, "mem1", "push1")
}
...
func TestCLIConsumerNext(t *testing.T) {
	...
	out := runJsmCli(t, fmt.Sprintf("--server='%s' con next mem1 push1 --raw", srv.ClientURL()))
...
func TestCLIStreamCopy(t *testing.T) {
	...
	runJsmCli(t, fmt.Sprintf("--server='%s' str cp mem1 file1 --storage file --subjects other", srv.ClientURL()))
...
func TestCLIConsumerCopy(t *testing.T) {
	...
	runJsmCli(t, fmt.Sprintf("--server='%s' con cp mem1 push1 pull1 --pull", srv.ClientURL()))
